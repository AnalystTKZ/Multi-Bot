...
# Quality/RL may use the backtest journal generated by Round 1+2, but raw market
# labels/features from validation/test are not folded into supervised fitting.
